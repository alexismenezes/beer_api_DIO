...
import one.digitalinnovation.beerstock.exception.BeerStockInvalidQuantityException;
...
public class BeerControllerTest {
    ...
    private static final String BEER_API_URL_PATH = "http://localhost:8080/api/v1/beers";
    ...
    void whenPATCHIsCalledToDecrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerStockInvalidQuantityException.class);
    ...
    void whenPATCHIsCalledWithInvalidBeerIdToDecrementThenNotFoundStatusIsReturned() throws Exception {
        ...
        Mockito.lenient().when(beerService.decrement(INVALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerNotFoundException.class);
